...
void Svgfile::AddEllispe(Coords const &centre, double radiusX, double radiusY, std::string colorFill)
{
    m_ostrm << "<ellipse "
            << attrib("cx", centre.getX())
            << attrib("cy", centre.getY())
            << attrib("rx", radiusX)
            << attrib("ry", radiusY)
            << attrib("fill", colorFill)
            << attrib("stroke", "purple")
...
void Svgfile::AddRectangle(Coords const &topLeft, Coords const &topRight,
                           Coords const &bottomLeft, Coords const &bottomRight, std::string colorFill)
{
